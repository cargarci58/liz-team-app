...
function TransactionDetail({ tx, onUpdate, onBack, contacts, onInviteParty = [], onSaveContact, onOpenContactBook, onDuplicate, currentUser }) {
  ...
  const CATEGORY_ORDER = ["Pre-Listing", "Consultation", "Contract", "Disclosure", "Marketing", "Showing", "Inspection", "Escrow", "HOA", "Financing", "Insurance", "Appraisal", "Title", "Closing", "Post-Closing", "Commission Disbursement", "General"];
