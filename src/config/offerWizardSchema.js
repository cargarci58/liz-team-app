  ...
  steps: [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "gg_agreement_parties", label: "Rider GG — Who signs the compensation agreement?", type: "select", required: false, showIfAddendum: "GG",
          default: "Seller's Broker and Buyer's Broker",
          options: ["Seller's Broker and Buyer's Broker", "Seller and Buyer's Broker"],
          why: "The 'check one' box on the rider: whether the listing brokerage or the seller personally agrees to pay your buyer-side compensation." },
