  ...
  steps: [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "loan_application_deadline_days", label: "Loan application within (days)", type: "number", required: false,
          showIf: { financing_type: ["Conventional", "FHA", "VA", "USDA", "Physician's Loan", "Bridge Loan", "Hard Money", "Seller Financing", "Other"] },
          hint: "Leave blank to use the contract's built-in default of 5 days.",
          why: "Standard FAR/BAR is 5 days. Leave blank and the form's 'if left blank then 5 days' applies." },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "title_evidence_paid_by", label: "Who pays for title insurance (owner's policy)?", type: "select", required: true,
          options: ["Seller", "Buyer", "Split 50/50"],
          why: "Custom varies by FL county: Miami-Dade/Broward = buyer pays; most other counties = seller pays. Default to local custom." },
        { id: "survey_required", label: "Survey required?", type: "select", required: true,
          options: ["Yes — buyer pays", "Yes — seller pays", "No survey"],
          why: "Lenders often require it. Reveals boundary issues, encroachments, easements. ~$400-700 in FL." },
    ...
    },
    {
      ...
      fields: [
        { id: "special_clauses", label: "Special clauses (free text)", type: "textarea", required: false,
